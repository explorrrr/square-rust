...
pub struct TerminalCheckoutV20230925 {
    ...
    pub payment_options: Option<PaymentOptionsV20230925>,
    /// Options to control the display and behavior of the Square Terminal device.
    pub device_options: DeviceCheckoutOptionsV20230925,
    ...
    pub payment_type: Option<CheckoutOptionsPaymentTypeV20230925>,
