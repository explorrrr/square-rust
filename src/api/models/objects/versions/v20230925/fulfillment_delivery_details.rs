...
use crate::api::models::enums::versions::v20230925::fulfillment_delivery_details_order_fulfillment_delivery_details_schedule_type::FulfillmentDeliveryDetailsOrderFulfillmentDeliveryDetailsScheduleTypeV20230925;

use super::fulfillment_recipient::FulfillmentRecipientV20230925;

/// Describes delivery details of an order fulfillment.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FulfillmentDeliveryDetailsV20230925 {
    ...
    pub schedule_type: Option<FulfillmentDeliveryDetailsOrderFulfillmentDeliveryDetailsScheduleTypeV20230925>,
    ...
    /// The time period after the deliver_at timestamp in which to deliver the order. Applications can set this field when the fulfillment state is PROPOSED, RESERVED, or PREPARED (any time before the terminal state such as COMPLETED, CANCELED, and FAILED).
    ///
    ...
    /// Read only The [timestamp](https://developer.squareup.com/docs/build-basics/working-with-dates) indicates when the seller completed the fulfillment. This field is automatically set when fulfillment state changes to COMPLETED. The timestamp must be in RFC 3339 format (for example, "2016-09-04T23:59:33.123Z").
    ///
    /// Examples for January 25th, 2020 6:25:34pm Pacific Standard Time:
    ///
    /// UTC: 2020-01-26T02:25:34Z
