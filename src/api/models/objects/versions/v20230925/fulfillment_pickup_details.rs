...
use crate::api::models::enums::versions::v20230925::fulfillment_pickup_details_schedule_type::FulfillmentPickupDetailsScheduleTypeV20230925;

use super::{fulfillment_recipient::FulfillmentRecipientV20230925, fulfillment_pickup_details_curbside_pickup_details::FulfillmentPickupDetailsCurbsidePickupDetailsV20230925};

/// Contains details necessary to fulfill a pickup order.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FulfillmentPickupDetailsV20230925 {
    ...
    pub schedule_type: Option<FulfillmentPickupDetailsScheduleTypeV20230925>,
    /// The [timestamp](https://developer.squareup.com/docs/build-basics/working-with-dates) that represents the start of the pickup window. Must be in RFC 3339 timestamp format, e.g., "2016-09-04T23:59:33.123Z".
    ///
    ...
    ///
    /// Examaples for January 25th, 2020 6:25:34pm Pacific Standard Time:
    ///
    /// UTC: 2020-01-26T02:25:34Z
    ///
    /// Pacific Standard Time with UTC offset: 2020-01-25T18:25:34-08:00
    ...
    /// Read only The [timestamp](https://developer.squareup.com/docs/build-basics/working-with-dates) indicating when the fulfillment is marked as ready for pickup. The timestamp must be in RFC 3339 format (for example, "2016-09-04T23:59:33.123Z").
    ///
    /// Examples for January 25th, 2020 6:25:34pm Pacific Standard Time:
    ///
    /// UTC: 2020-01-26T02:25:34Z
    ...
    pub curbside_pickup_details: Option<FulfillmentPickupDetailsCurbsidePickupDetailsV20230925>,
}
