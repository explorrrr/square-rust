...
pub struct CatalogDiscountV20230925 {
    /// The discount name. This is a searchable attribute for use in applicable query filters, and its value length is of Unicode code points.
    /// Max Length 255
    pub name: Option<String>,
    /// Indicates whether the discount is a fixed amount or percentage, or entered at the time of sale.
    pub discount_type: Option<CatalogDiscountTypeV20230925>,
    ...
    pub modify_tax_basis: Option<CatalogDiscountModifyTaxBasisV20230925>,
    ...
    pub maximum_amount_money: Option<MoneyV20230925>,
}
