...
pub struct TaxIdsV20230925 {
    /// Read only The EU VAT number for this location. For example, IE3426675K. If the EU VAT number is present, it is well-formed and has been validated with VIES, the VAT Information Exchange System.
    ...
    /// Read only The QII (Qualified Invoice Issuer) number is a 14-character tax identifier used in Japan. For example, T1234567890123.
