...
pub struct OrderReturnLineItemV20230925 {
    ...
    pub return_modifiers: Option<Vec<OrderReturnLineItemModifierV20230925>>,
    ...
    pub gross_return_money: Option<MoneyV20230925>,
