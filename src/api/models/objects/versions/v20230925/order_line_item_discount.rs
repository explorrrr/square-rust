...
pub struct OrderLineItemDiscountV20230925 {
    ...
    /// Read only The object ID of a [pricing rule](https://developer.squareup.com/reference/square/objects/CatalogPricingRule) to be applied automatically to this discount. The specification and application of the discounts, to which a pricing_rule_id is assigned, are completely controlled by the corresponding pricing rule.
