...
use crate::api::models::enums::versions::v20230925::day_of_week::DayOfWeekV20230925;

/// Represents a period of time during which a business location is open.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct BusinessHoursPeriodV20230925 {
    /// The day of the week for this time period.
    pub day_of_week: Option<DayOfWeekV20230925>,
