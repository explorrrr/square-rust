...
pub struct PayoutV20230925 {
    /// A unique ID for the payout.
    ///
    /// Min Length 1
    pub id: String,
    /// Indicates the payout status.
    pub status: Option<PayoutStatusV20230925>,
    ...
    pub destination: Option<DestinationV20230925>,
