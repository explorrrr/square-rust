...
pub struct CustomerFilterV20230925 {
    /// A filter to select customers based on their creation source.
    pub creation_source: Option<CustomerCreationSourceFilterV20230925>,
    ...
    pub updated_at: Option<TimeRangeV20230925>,
    ...
    pub email_address: Option<CustomerTextFilterV20230925>,
    ...
    pub phone_number: Option<CustomerTextFilterV20230925>,
    ...
    pub reference_id: Option<CustomerTextFilterV20230925>,
    ...
    pub group_ids: Option<FilterValueV20230925>,
    ...
    pub custom_attribute: Option<CustomerCustomAttributeFiltersV20230925>,
    ...
    pub segment_ids: Option<FilterValueV20230925>,
}
