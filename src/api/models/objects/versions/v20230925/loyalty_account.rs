...
pub struct LoyaltyAccountV20230925 {
    ...
    pub mapping: Option<LoyaltyAccountMappingV20230925>,
    ...
    pub expiring_point_deadlines: Option<Vec<LoyaltyAccountExpiringPointDeadlineV20230925>>,
}
