...
use super::{checkout_options::CheckoutOptionsV20230925, pre_populated_data::PrePopulatedDataV20230925};

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PaymentLinkV20230925 {
    ...
    checkout_options: Option<CheckoutOptionsV20230925>,
    /// Describes buyer data to prepopulate on the checkout page.
    pre_populated_data: Option<PrePopulatedDataV20230925>,
