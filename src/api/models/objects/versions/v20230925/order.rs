...
pub struct OrderV20230925 {
    ...
    pub source: Option<OrderSourceV20230925>,
    ...
    pub line_items: Option<Vec<OrderLineItemV20230925>>,
    ...
    pub taxes: Option<Vec<OrderLineItemTaxV20230925>>,
    ...
    pub discounts: Option<Vec<OrderLineItemDiscountV20230925>>,
    /// A list of service charges applied to the order.
    pub service_charges: Option<Vec<OrderServiceChargeV20230925>>,
    ...
    pub fulfillments: Option<Vec<FulfillmentV20230925>>,
    ...
    pub returns: Option<Vec<OrderReturnV20230925>>,
    ...
    pub net_amounts: Option<OrderMoneyAmountsV20230925>,
    ...
    pub tenders: Option<Vec<TenderV20230925>>,
    /// Read only The refunds that are part of this order.
    pub refunds: Option<Vec<RefundV20230925>>,
    ...
    pub total_tip_money: Option<MoneyV20230925>,
    ...
    pub pricing_options: Option<OrderPricingOptionsV20230925>,
    /// Read only A set-like list of Rewards that have been added to the Order.
    pub rewards: Option<Vec<OrderRewardV20230925>>,
    /// Read only The net amount of money due on the order.
    pub net_amount_due_money: Option<MoneyV20230925>,
}
