...
pub struct CatalogPricingRuleV20230925 {
    ...
    /// Represents the local time the pricing
    /// rule should be valid until. Represented in RFC 3339 partial-time format (HH:MM:SS). Partial seconds will be truncated.
