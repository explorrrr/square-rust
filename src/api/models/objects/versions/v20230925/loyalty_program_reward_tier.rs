...
use super::catalog_object_reference::CatalogObjectReferenceV20230925;
...
pub struct LoyaltyProgramRewardTierV20230925 {
    ...
    pub pricing_rule_reference: CatalogObjectReferenceV20230925,
}
