...
pub struct TeamMemberBookingProfileV20230925 {
    /// Read only The ID of the [TeamMember](https://developer.squareup.com/reference/square/objects/TeamMember) object for the team member associated with the booking profile.
    ///
    /// Max Length 32
