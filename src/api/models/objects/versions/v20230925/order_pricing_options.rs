...
///
/// The options affect how the order's price is calculated. They can be used, for example, to apply automatic price adjustments that are based on preconfigured [pricing rules](https://developer.squareup.com/reference/square/objects/CatalogPricingRule).
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct OrderPricingOptionsV20230925 {
